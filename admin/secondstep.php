...
<body>
    <header>
      ...
      <div class="main-content-header">
          ...
          <table class="table1">
              <span> <h4 class="h_3">Mid Exam (A)</h4></span>
             <tr>
                <th>Bangla</th>   <th> English </th> <th>Math</th>
             </tr>
             <tr>
                 <td><input type='text' name='bangla1' placeholder='Bangla' required/></td>
         ...
         <table class="table4">
             ...
             <tr>
                 <td><input type='text' name='bangla2' placeholder='Bnagla' required/></td>
